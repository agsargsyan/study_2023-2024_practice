...
set terminal postscript eps
set output "av_queues_red.eps"
set xlabel "Time (s)"
set ylabel "Queue Length"
set title "Average queues"
plot "temp_NL.a" with lines linestyle 1 lt 1 lw 2 title "nonlinear", "temp_reno_75_150.a" with lines linestyle 1 lt 3 lw 2 title "classic"   
